...
/**
 * @title ConformationalRegistryV2
 * @notice V2 changes vs V1: extended event with full record fields
 *         for efficient off-chain indexing (fuzzy similarity search).
 *
 ...
 * @author Jakub Hryc
 */
contract ConformationalRegistryV2 {
